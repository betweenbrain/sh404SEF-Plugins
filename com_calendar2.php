 ...
 */
class  Sh404sefExtpluginCom_calendar2 extends Sh404sefClassBaseextplugin {

	protected $_extName = 'com_calendar2';
	...
	protected function _findSefPluginPath($nonSefVars = array()) {
		...
		$this->_sefPluginPath = JPATH_ROOT . DS . 'plugins' . DS . 'sh404sefextplugins' . DS . 'plugins' . DS . 'com_calendar2.php';
	}
}